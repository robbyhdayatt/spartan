                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        $statusClass = ['draft'=>'secondary', 'pending_approval'=>'warning', 'approved'=>'info', 'ordered'=>'primary', 'partial_received'=>'info', 'received'=>'success', 'completed'=>'success', 'cancelled'=>'danger'][$pembelian->status_pembelian] ?? 'light';
                                    @endphp
                                ...
                                <td>
                                    ...
                                    {{-- Tombol ini hanya akan muncul jika PO sudah disetujui dan belum selesai diterima --}}
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createModalLabel">Buat Purchase Order Baru</h5>
      ...
      <form action="{{ route('pembelian.store') }}" method="POST">
        ...
        <div class="modal-body">
            ...
            <table class="table table-bordered">
                <thead><tr><th>Part</th><th>Qty</th><th>Harga Satuan</th><th>Subtotal</th><th>Aksi</th></tr></thead>
                <tbody id="details-container"></tbody>
            </table>
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="detailModalLabel">Detail Purchase Order</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      <div class="modal-body">
        <div class="row mb-3">
...
$(document).ready(function() {
    ...
    $('#btn-create-po').on('click', function(e) {
        e.preventDefault();
    ...
    $('.btn-detail').on('click', function(e) {
        ...
        $.ajax({
            ...
            error: function() {
                 $('#detail-items-table').html('<tr><td colspan="5" class="text-center text-danger">Gagal memuat data.</td></tr>');
            }
        });
    });
